...
void BotMgr::LoadConfig(bool force)
{
    ...
    _enableNpcBots          = ConfigMgr::GetBoolDefault("NpcBot.Enable", true);
    _allowgm                = ConfigMgr::GetBoolDefault("NpcBot.AllowGM", true);
    _maxNpcBots             = ConfigMgr::GetIntDefault("NpcBot.MaxBots", 1);
    _maxClassNpcBots        = ConfigMgr::GetIntDefault("NpcBot.MaxBotsPerClass", 1);
    _basefollowdist         = ConfigMgr::GetIntDefault("NpcBot.BaseFollowDistance", 30);
    _xpReductionNpcBots     = ConfigMgr::GetIntDefault("NpcBot.XpReduction", 0);
    _healTargetIconFlags    = ConfigMgr::GetIntDefault("NpcBot.HealTargetIconsMask", 0);
    _mult_dmg_melee         = ConfigMgr::GetFloatDefault("NpcBot.Mult.Damage.Melee", 1.0);
    _mult_dmg_spell         = ConfigMgr::GetFloatDefault("NpcBot.Mult.Damage.Spell", 1.0);
    _mult_healing           = ConfigMgr::GetFloatDefault("NpcBot.Mult.Healing", 1.0);
    _enableNpcBotsDungeons  = ConfigMgr::GetBoolDefault("NpcBot.Enable.Dungeon", true);
    _enableNpcBotsRaids     = ConfigMgr::GetBoolDefault("NpcBot.Enable.Raid", false);
    _enableNpcBotsBGs       = ConfigMgr::GetBoolDefault("NpcBot.Enable.BG", false);
    _enableNpcBotsArenas    = ConfigMgr::GetBoolDefault("NpcBot.Enable.Arena", false);
    _enableDungeonFinder    = ConfigMgr::GetBoolDefault("NpcBot.Enable.DungeonFinder", true);
    _limitNpcBotsDungeons   = ConfigMgr::GetBoolDefault("NpcBot.Limit.Dungeon", true);
    _limitNpcBotsRaids      = ConfigMgr::GetBoolDefault("NpcBot.Limit.Raid", true);
    _npcBotsCost            = ConfigMgr::GetIntDefault("NpcBot.Cost", 1000000);
    _botPvP                 = ConfigMgr::GetBoolDefault("NpcBot.PvP", true);
...
BotAddResult BotMgr::AddBot(Creature* bot, bool takeMoney)
{
    ...
    {
        bot->SetBotCommandState(COMMAND_FOLLOW, true);
        //Always Party if (bot->GetBotAI()->HasRole(BOT_ROLE_PARTY))
            AddBotToGroup(bot);
    }
